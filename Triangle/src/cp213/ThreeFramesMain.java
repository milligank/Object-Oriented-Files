...
public class ThreeFramesMain {
    ...
    final JComponent sameview = new RTSameView(model);
	final JFrame sameframe = new JFrame("Right Triangle");
	sameframe.setContentPane(sameview);
	sameframe.setSize(300, 300);
	sameframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	sameframe.setVisible(true);
    }
    // ---------------------------------------------------------------
}
